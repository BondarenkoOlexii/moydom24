...
urlpatterns = [
    ...
    path('house/create_house', CreateHouse.as_view(template_name="create_user.html"), name='create_house'),
    path('house/update/<int:pk>', UpdateHouse.as_view(template_name="create_user.html"), name='update_house'),
