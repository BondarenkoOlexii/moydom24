...
SECRET_KEY = 'django-insecure-j!)*z2&qr&zipia-aiw_k2otd1)56i*_7=b=&bxl7*t^ypo_y('
...
ADMINPANEL_APPS = [
    ...
    'src.site_control.apps.SiteControlConfig',
...
INSTALLED_APPS += ADMINPANEL_APPS
INSTALLED_APPS += FRONTEND_APPS
...
EMAIL_USE_TLS = True
EMAIL_USE_SSL = False
EMAIL_HOST_USER = 'mayoright01@gmail.com'
EMAIL_HOST_PASSWORD = 'tvprghdmkwhaarie'
